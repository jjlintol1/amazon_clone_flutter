                        ...
                        return CustomMainButton(
                          ...
                          onPressed: () async {
                            await CloudFirestoreClass().buyAllItemsInCart(
                              userDetails: Provider.of<UserDetailsProvider>(context, listen: false).userDetails
                            );
                            Utils().showSnackBar(context: context, content: "${snapshot.data!.docs.length} items ordered");
                          }
                        );
                      }
                    },
